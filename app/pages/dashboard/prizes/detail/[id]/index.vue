...
import { Award, Users, Trash2, Clock, MoreHorizontal, Edit, Building, FileText, CirclePlus } from 'lucide-vue-next'
...
// TODO: Akademisyen arama — idas-api'de kullanıcı/akademisyen arama ucu henüz yok.
// Uç gelince GET ile aratıp sonuçları academicianResults'a dolduracağız.
...
// TODO (hoca: araştırmacı ekleme ayrı olsun, istek en son): araştırmacı ekleme isteği henüz bağlı değil.
// Hazır olunca -> POST /awards/${prizeId}/user-awards { userId: selectedAcademician.id } sonra refreshRecipients()
